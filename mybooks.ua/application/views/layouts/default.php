<!-- файл призначений для виводу основних частин сайту, якіне змінються(футер,сайдбар, хедер...) -->
<!DOCTYPE html>
<html lang="ru">
...
<head>
    ...
    <link rel="stylesheet" href="/libs/books-page/books-page_files/libs.min.css">
    <link rel="stylesheet" href="/libs/books-page/books-page_files/style.css">

   <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css"
          crossorigin="anonymous"/>

    <link rel="shortcut icon" href="http://mybooks.ua/favicon.ico">
    <style>
        .details {
            display: none;
        }
    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                <div class="logo"><a href="http://mybooks.ua/" class="navbar-brand"><span class="sh">Ш</span><span
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <form method="POST" action="search" class="navbar-form navbar-right">
                            <div class="form-group">
                                <input type="text" name="title" placeholder="Пошук книги" class="form-control">
                            </div>
                        </form>
                    </div>
                </div>
